          ...
          <el-row :gutter="10" style="padding: 10px 0;">
            <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="3">
              <div class="grid-content">
                ...
                <ResMessageBox :drawer="drawer" :resMessage="curRes" :AttrMessageZh="AttrMessageZh"
                               @closeDrawer="closeDrawer"></ResMessageBox>
              </div>
            </el-col>
...
<script>
  ...
  import Tabs from '../../components/datacenterComponents/Statistics/Tabs'//选择班次
  import SelectDate from '../../components/datacenterComponents/Statistics/SelectDate'//选择日期
  import ResMessageBox from '../../components/datacenterComponents/Statistics/ResMessageBox'//设备详细信息的展示
  export default {
    name: "statistics",
    components: {
      LayOut, Tabs,
...
<style scoped>
  ...
  #resHover li, #resProductHover li {
