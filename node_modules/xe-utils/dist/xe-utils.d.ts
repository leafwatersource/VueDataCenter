...
declare namespace XEUtils {
  ...
  */
   ...
   * @param context 上下文
   */
  export function lastObjectEach(obj: any, iterate: (item: any, key: string, obj: any) => void, context?: any): void;
  ...
  */
   ...
   * @param context 上下文
   */
  export function sortBy<T>(array: T[], iterate: any[] | string | ((item: T, index: number, list: T[]) => boolean), context?: any): T[];
   ...
   * @param context 上下文
   */
  export function every<T>(list: T[], iterate: (item: T, index: number, list: T[]) => boolean, context?: any): boolean;
   ...
   * @param context 上下文
   */
  export function every<T>(list: T, iterate: (item: any, key: string, list: T) => boolean, context?: any): boolean;
   ...
   * @param context 上下文
   */
  export function filter<T>(array: T[], iterate: (item: T, index: number, list: T[]) => boolean, context?: any): T[];
   ...
   * @param context 上下文
   */
  export function filter<T>(obj: T, iterate: (item: any, key: string, list: T) => boolean, context?: any): any;
   ...
   * @param context 上下文
   */
  export function find<T>(list: T[], iterate: (item: T, index: number, list: T[]) => boolean, context?: any): T;
   ...
   * @param context 上下文
   */
  export function find<T>(obj: T, iterate: (item: any, key: string, obj: T) => boolean, context?: any): any;
   ...
   * @param context 上下文
   */
  export function findLast<T>(array: T[], iterate: (item: T, index: number, list: T[]) => boolean, context?: any): T;
   ...
   * @param context 上下文
   */
  export function findLast<T>(obj: T, iterate: (item: any, key: string, obj: T) => boolean, context?: any): any;
   ...
   * @param context 上下文
   */
  export function findKey<T>(list: T[], iterate: (item: T, index: number, list: T[]) => boolean, context?: any): number;
   ...
   * @param context 上下文
   */
  export function findKey<T>(obj: T, iterate: (item: any, key: string, obj: T) => boolean, context?: any): any;
   ...
   * @param context 上下文
   */
  export function map<T, U>(list: T[], iterate: (item: T, index: number, list: T[]) => U, context?: any): U[];
   ...
   * @example
   */
  export function invoke(list: any[], path: string[] | string | ((...args: any[]) => any)): any[];
   ...
   * @param context 上下文
   */
  export function arrayEach<T>(list: T[], iterate: (item: T, index: number, list: T[]) => void, context?: any): void;
   ...
   * @param context 上下文
   */
  export function lastArrayEach<T>(obj: T[], iterate: (item: T, index: number, list: T[]) => void, context?: any): void;
   ...
   */
  export function toArrayTree<T>(list: T[], options?: ToArrayTreeOptions): T[];
   ...
   */
  export function findTree<T>(list: T[], iterate: (item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => boolean, options?: FindTreeOptions, context?: any): TerrResult;
   ...
   * @param {Object} context 上下文
   */
  export function eachTree<T>(list: T[], iterate: (item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => void, options?: EachTreeOptions, context?: any): void;
   ...
   * @param {Object} context 上下文
   */
  export function mapTree<T, U>(array: T[], iterate: (item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => U, options?: MapTreeOptions, context?: any): U[];
   ...
   * @param {Object} context 上下文
   */
  export function filterTree<T>(list: T[], iterate: (item: T, index: number, items: T[], path: string[], parent: T, nodes: T[]) => boolean, options?: FilterTreeOptions, context?: any): T[];
   ...
   * @param context 上下文
   */
  export function findIndexOf<T>(list: T[], iterate: (item: T, index: any, obj: T[]) => boolean, context?: any): number;
   ...
   * @param context 上下文
   */
  export function findIndexOf<T>(obj: T, iterate: (item: any, key: string, obj: T) => boolean, context?: any): number;
   ...
   * @param context 上下文
   */
  export function findLastIndexOf<T>(list: T, iterate: (item: T, index: number, list: T[]) => boolean, context?: any): T;
   ...
   * @param context 上下文
   */
  export function findLastIndexOf(obj: any, iterate: (item: any, key: string, obj: any) => boolean, context?: any): any;
   ...
   * @param context 上下文
   */
  export function each<T>(list: T[], iterate: (item: T, index: number, list: T[]) => void, context?: any): void;
   ...
   * @param context 上下文
   */
  export function each<T>(obj: T, iterate: (item: any, key: string, obj: T) => void, context?: any): void;

  /**
   * 已废弃，被 some, every 替换
   */
  export function forOf(obj: any, iterate: (item: any, index: any, obj: any) => boolean, context?: any): void;

  /**
   * 已废弃
   */
  export function lastForOf(obj: any, iterate: (item: any, index: any, obj: any) => boolean, context?: any): void;
   ...
   * @param context 上下文
   */
  export function lastEach<T>(list: T[], iterate: (item: T, index: any, list: T) => void, context?: any): void;
   ...
   * @param context 上下文
   */
  export function lastEach(obj: any, iterate: (item: any, key: string, obj: any) => void, context?: any): void;
   ...
   * @param context 上下文
   */
  export function groupBy<T>(list: T[], iterate: string | number | ((item: T, index: number, obj: T) => string | number), context?: any): { [key: string]: T[] };
   ...
   * @param context 上下文
   */
  export function groupBy<T>(obj: T, iterate: string | number | ((item: any, key: string, obj: T) => string | number), context?: any): { [key: string]: any[] };
   ...
   * @param context 上下文
   */
  export function countBy<T>(list: T[], iterate: (item: T, index: number, list: T) => string | number, context?: any): { [key: string]: number };
   ...
   * @param context 上下文
   */
  export function countBy<T>(obj: T, iterate: (item: any, key: string, obj: T) => string | number, context?: any): { [key: string]: number };
   ...
   * @param iterate 迭代器/值
   */
  export function remove<T>(list: T[], iterate: number | string | ((item: T, index: number, list: T[]) => boolean)): T[];
   ...
   * @param iterate 迭代器/值
   */
  export function remove(obj: any, iterate: number | string | ((item: any, key: string, obj: any) => boolean)): any;
   ...
   * @param digits 小数保留位数
   */
  export function round(num: string | number, digits?: number): number;
   ...
   * @param digits 小数保留位数
   */
  export function toFixed(num: string | number, digits?: number): string;
   ...
   * @param num 数值
   */
  export function toNumberString(num: number): string;
   ...
   * @param context 上下文
   */
  export function sum<T>(obj: T[], iterate?: string | number | ((item: T, index: number, list: T[]) => number), context?: any): number;
   ...
   */
  export function toStringDate(str: string | Date | number): Date;
   ...
   */
  export function toDateString(date: string | Date | number, format: string): string;
   ...
   * @param params 额外的参数
   */
  export function bind(callback: (...args: any[]) => any, context?: any, ...params: any[]): (...args: any[]) => any;
   ...
   * @param params 额外的参数
   */
  export function once(callback: (...args: any[]) => any, context?: any, ...params: any[]): (...args: any[]) => any;
   ...
   * @param context 上下文
   */
  export function after(count: number, callback: (rests: any[], ...args: any[]) => any, context?: any): Function;
   ...
   * @param context 上下文
   */
  export function before(count: number, callback: (rests: any[], ...args: any[]) => any, context?: any): (...args: any[]) => any;
   ...
   * @param options 可选参数
   */
  export function throttle(callback: (...args: any[]) => any, wait: number, options?: ThrottleOptions): (...args: any[]) => any;
   ...
   * @param options 可选参数
   */
  export function debounce(callback: (...args: any[]) => any, wait: number, options?: DebounceOptions): (...args: any[]) => any;
